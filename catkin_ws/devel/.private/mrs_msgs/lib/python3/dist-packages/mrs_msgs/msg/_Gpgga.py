...
"""autogenerated by genpy from mrs_msgs/Gpgga.msg. Do not edit."""
import codecs
import sys
...
class Gpgga(genpy.Message):
  _md5sum = "60c1dbabb1ff7bc913853a9cc2abcc73"
  _type = "mrs_msgs/Gpgga"
...
"""
  __slots__ = ['header','message_id','utc_seconds','latitude','longitude','latitude_dir','longitude_dir','gps_quality','num_sats','hdop','altitude','altitude_units','undulation','undulation_units','diff_age','station_id']
  _slot_types = ['std_msgs/Header','string','float64','float64','float64','string','string','mrs_msgs/GpsStatus','uint32','float32','float32','string','float32','string','uint32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,message_id,utc_seconds,latitude,longitude,latitude_dir,longitude_dir,gps_quality,num_sats,hdop,altitude,altitude_units,undulation,undulation_units,diff_age,station_id
    ...
    if args or kwds:
      ...
      if self.gps_quality is None:
        self.gps_quality = mrs_msgs.msg.GpsStatus()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d().pack(_x.utc_seconds, _x.latitude, _x.longitude))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2I2f().pack(_x.gps_quality.quality, _x.num_sats, _x.hdop, _x.altitude))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.utc_seconds, _x.latitude, _x.longitude,) = _get_struct_3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.gps_quality.quality, _x.num_sats, _x.hdop, _x.altitude,) = _get_struct_2I2f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end

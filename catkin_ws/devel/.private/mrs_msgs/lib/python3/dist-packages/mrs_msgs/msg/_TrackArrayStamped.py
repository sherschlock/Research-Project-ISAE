...
"""autogenerated by genpy from mrs_msgs/TrackArrayStamped.msg. Do not edit."""
import codecs
import sys
...
class TrackArrayStamped(genpy.Message):
  _md5sum = "f0b496542aa3b02d9554e3f84cdfe92e"
  _type = "mrs_msgs/TrackArrayStamped"
...
float64 z"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackArrayStamped, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.tracks:
        ...
        _x = _v3
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        buff.write(_get_struct_9d().pack(*val1.velocity_covariance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.velocity_covariance = _get_struct_9d().unpack(str[start:end])
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.velocity_covariance = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=9)
        self.tracks.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill

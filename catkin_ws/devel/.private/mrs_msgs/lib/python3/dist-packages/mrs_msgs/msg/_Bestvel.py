...
"""autogenerated by genpy from mrs_msgs/Bestvel.msg. Do not edit."""
import codecs
import sys
...
class Bestvel(genpy.Message):
  _md5sum = "02a85bdf86c56792843f3c24e6d61e43"
  _type = "mrs_msgs/Bestvel"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# See section 3.1.4 BESTVEL in https://www.tersus-gnss.com/assets/upload/file/20180608173259349.pdf
# --------------------------------------------------------------------------------------
...
"""
  __slots__ = ['header','tersus_msg_header','solution_status','velocity_type','latency','age','horizontal_speed','track_ground','vertical_speed']
  _slot_types = ['std_msgs/Header','mrs_msgs/TersusMessageHeader','string','string','float32','float32','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,tersus_msg_header,solution_status,velocity_type,latency,age,horizontal_speed,track_ground,vertical_speed

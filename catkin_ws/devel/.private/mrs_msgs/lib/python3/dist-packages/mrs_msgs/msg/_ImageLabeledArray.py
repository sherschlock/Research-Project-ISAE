...
"""autogenerated by genpy from mrs_msgs/ImageLabeledArray.msg. Do not edit."""
import codecs
import sys
...
class ImageLabeledArray(genpy.Message):
  _md5sum = "3994e4c6237f0873af89ad4ed9eb17f3"
  _type = "mrs_msgs/ImageLabeledArray"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# This message represents an Image and corresponding camera label
...
"""
  __slots__ = ['header','imgs_labeled']
  _slot_types = ['std_msgs/Header','mrs_msgs/ImageLabeled[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageLabeledArray, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.imgs_labeled)
      buff.write(_struct_I.pack(length))
      for val1 in self.imgs_labeled:
        _x = val1.label
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = mrs_msgs.msg.ImageLabeled()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end

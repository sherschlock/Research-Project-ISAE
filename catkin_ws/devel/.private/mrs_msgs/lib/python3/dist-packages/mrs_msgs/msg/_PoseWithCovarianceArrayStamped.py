...
"""autogenerated by genpy from mrs_msgs/PoseWithCovarianceArrayStamped.msg. Do not edit."""
import codecs
import sys
...
class PoseWithCovarianceArrayStamped(genpy.Message):
  _md5sum = "3dc32bc5b82667712bb3f8fdf00477a4"
  _type = "mrs_msgs/PoseWithCovarianceArrayStamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','mrs_msgs/PoseWithCovarianceIdentified[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseWithCovarianceArrayStamped, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = mrs_msgs.msg.PoseWithCovarianceIdentified()
        start = end
        end += 8

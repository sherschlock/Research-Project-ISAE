// Generated by gencpp from file mrs_msgs/RangeInformation.msg
// DO NOT EDIT!


#ifndef MRS_MSGS_MESSAGE_RANGEINFORMATION_H
#define MRS_MSGS_MESSAGE_RANGEINFORMATION_H
...
struct RangeInformation_
{
  ...
  typedef boost::shared_ptr< ::mrs_msgs::RangeInformation_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::mrs_msgs::RangeInformation_<ContainerAllocator> const> ConstPtr;

}; // struct RangeInformation_

typedef ::mrs_msgs::RangeInformation_<std::allocator<void> > RangeInformation;

typedef boost::shared_ptr< ::mrs_msgs::RangeInformation > RangeInformationPtr;
typedef boost::shared_ptr< ::mrs_msgs::RangeInformation const> RangeInformationConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::mrs_msgs::RangeInformation_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::mrs_msgs::RangeInformation_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::mrs_msgs::RangeInformation_<ContainerAllocator1> & lhs, const ::mrs_msgs::RangeInformation_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::mrs_msgs::RangeInformation_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mrs_msgs::RangeInformation_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mrs_msgs::RangeInformation_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mrs_msgs::RangeInformation_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mrs_msgs::RangeInformation_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mrs_msgs::RangeInformation_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::mrs_msgs::RangeInformation_<ContainerAllocator> >
{
  ...
  static const char* value(const ::mrs_msgs::RangeInformation_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2c29299d245fc707ULL;
  static const uint64_t static_value2 = 0xe8f7544af871f110ULL;
};

template<class ContainerAllocator>
struct DataType< ::mrs_msgs::RangeInformation_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::mrs_msgs::RangeInformation_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::mrs_msgs::RangeInformation_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::mrs_msgs::RangeInformation_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mrs_msgs::RangeInformation_<ContainerAllocator>& v)
  {
    s << indent << "prn_number: ";
...
#endif // MRS_MSGS_MESSAGE_RANGEINFORMATION_H

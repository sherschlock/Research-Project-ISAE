// Generated by gencpp from file mrs_msgs/PositionCommand.msg
// DO NOT EDIT!


#ifndef MRS_MSGS_MESSAGE_POSITIONCOMMAND_H
#define MRS_MSGS_MESSAGE_POSITIONCOMMAND_H
...
struct PositionCommand_
{
  ...
  typedef boost::shared_ptr< ::mrs_msgs::PositionCommand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::mrs_msgs::PositionCommand_<ContainerAllocator> const> ConstPtr;

}; // struct PositionCommand_

typedef ::mrs_msgs::PositionCommand_<std::allocator<void> > PositionCommand;

typedef boost::shared_ptr< ::mrs_msgs::PositionCommand > PositionCommandPtr;
typedef boost::shared_ptr< ::mrs_msgs::PositionCommand const> PositionCommandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::mrs_msgs::PositionCommand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::mrs_msgs::PositionCommand_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::mrs_msgs::PositionCommand_<ContainerAllocator1> & lhs, const ::mrs_msgs::PositionCommand_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::mrs_msgs::PositionCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mrs_msgs::PositionCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mrs_msgs::PositionCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mrs_msgs::PositionCommand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mrs_msgs::PositionCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mrs_msgs::PositionCommand_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::mrs_msgs::PositionCommand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::mrs_msgs::PositionCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4d8e95e3ee792c1aULL;
  static const uint64_t static_value2 = 0x5ce3afe2d9f2396aULL;
};

template<class ContainerAllocator>
struct DataType< ::mrs_msgs::PositionCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::mrs_msgs::PositionCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::mrs_msgs::PositionCommand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::mrs_msgs::PositionCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mrs_msgs::PositionCommand_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // MRS_MSGS_MESSAGE_POSITIONCOMMAND_H

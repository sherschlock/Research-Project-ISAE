// Generated by gencpp from file mrs_msgs/TrackstatChannel.msg
// DO NOT EDIT!


#ifndef MRS_MSGS_MESSAGE_TRACKSTATCHANNEL_H
#define MRS_MSGS_MESSAGE_TRACKSTATCHANNEL_H
...
struct TrackstatChannel_
{
  ...
  typedef boost::shared_ptr< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> const> ConstPtr;

}; // struct TrackstatChannel_

typedef ::mrs_msgs::TrackstatChannel_<std::allocator<void> > TrackstatChannel;

typedef boost::shared_ptr< ::mrs_msgs::TrackstatChannel > TrackstatChannelPtr;
typedef boost::shared_ptr< ::mrs_msgs::TrackstatChannel const> TrackstatChannelConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::mrs_msgs::TrackstatChannel_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::mrs_msgs::TrackstatChannel_<ContainerAllocator1> & lhs, const ::mrs_msgs::TrackstatChannel_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> >
{
  ...
  static const char* value(const ::mrs_msgs::TrackstatChannel_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x295831118c5ddfb8ULL;
  static const uint64_t static_value2 = 0x3ac5b655586ae7efULL;
};

template<class ContainerAllocator>
struct DataType< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::mrs_msgs::TrackstatChannel_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mrs_msgs::TrackstatChannel_<ContainerAllocator>& v)
  {
    s << indent << "prn: ";
...
#endif // MRS_MSGS_MESSAGE_TRACKSTATCHANNEL_H

...
class Path {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('override_max_jerk_horizontal')) {
        this.override_max_jerk_horizontal = initObj.override_max_jerk_horizontal
      }
      else {
      ...
      if (initObj.hasOwnProperty('override_max_jerk_vertical')) {
        this.override_max_jerk_vertical = initObj.override_max_jerk_vertical
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [override_max_jerk_horizontal]
    bufferOffset = _serializer.float64(obj.override_max_jerk_horizontal, buffer, bufferOffset);
    ...
    // Serialize message field [override_max_jerk_vertical]
    bufferOffset = _serializer.float64(obj.override_max_jerk_vertical, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [override_max_jerk_horizontal]
    data.override_max_jerk_horizontal = _deserializer.float64(buffer, bufferOffset);
    ...
    // Deserialize message field [override_max_jerk_vertical]
    data.override_max_jerk_vertical = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.override_max_jerk_horizontal !== undefined) {
      resolved.override_max_jerk_horizontal = msg.override_max_jerk_horizontal;
    }
    else {
      resolved.override_max_jerk_horizontal = 0.0
    }
    ...
    if (msg.override_max_jerk_vertical !== undefined) {
      resolved.override_max_jerk_vertical = msg.override_max_jerk_vertical;
    }
    else {
      resolved.override_max_jerk_vertical = 0.0
    }

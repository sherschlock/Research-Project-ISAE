...
(cl:defclass <TrackStamped> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
   ...
   (track
    :reader track
    :initarg :track
    :type mrs_msgs-msg:Track
    :initform (cl:make-instance 'mrs_msgs-msg:Track)))
)

(cl:defclass TrackStamped (<TrackStamped>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <TrackStamped>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'TrackStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrs_msgs-msg:<TrackStamped> is deprecated: use mrs_msgs-msg:TrackStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <TrackStamped>))
...
(cl:defmethod track-val ((m <TrackStamped>))
  ...
  (track m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TrackStamped>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrackStamped>) istream)

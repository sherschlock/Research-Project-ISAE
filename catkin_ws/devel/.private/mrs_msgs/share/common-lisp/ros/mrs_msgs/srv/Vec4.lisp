...
(cl:defmethod cl:initialize-instance :after ((m <Vec4-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vec4-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrs_msgs-srv:<Vec4-request> is deprecated: use mrs_msgs-srv:Vec4-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Vec4-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vec4-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrs_msgs-srv:<Vec4-response> is deprecated: use mrs_msgs-srv:Vec4-response instead.")))

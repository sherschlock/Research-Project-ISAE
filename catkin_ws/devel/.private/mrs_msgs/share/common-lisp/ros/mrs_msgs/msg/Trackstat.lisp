...
(cl:defclass <Trackstat> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (channels
    :reader channels
    :initarg :channels
    :type (cl:vector mrs_msgs-msg:TrackstatChannel)
   :initform (cl:make-array 0 :element-type 'mrs_msgs-msg:TrackstatChannel :initial-element (cl:make-instance 'mrs_msgs-msg:TrackstatChannel))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Trackstat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trackstat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrs_msgs-msg:<Trackstat> is deprecated: use mrs_msgs-msg:Trackstat instead.")))
...
(cl:defmethod cutoff-val ((m <Trackstat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:cutoff-val is deprecated.  Use mrs_msgs-msg:cutoff instead.")
  (cutoff m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Trackstat>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'channels)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'mrs_msgs-msg:TrackstatChannel))

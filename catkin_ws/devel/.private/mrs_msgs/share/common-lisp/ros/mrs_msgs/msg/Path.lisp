...
(cl:defclass <Path> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (override_max_jerk_horizontal
    :reader override_max_jerk_horizontal
    :initarg :override_max_jerk_horizontal
    :type cl:float
    :initform 0.0)
   ...
   (override_max_jerk_vertical
    :reader override_max_jerk_vertical
    :initarg :override_max_jerk_vertical
    :type cl:float
    :initform 0.0)
   (relax_heading
...
(cl:defmethod cl:initialize-instance :after ((m <Path>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrs_msgs-msg:<Path> is deprecated: use mrs_msgs-msg:Path instead.")))
...
(cl:defmethod input_id-val ((m <Path>))
...
(cl:defmethod use_heading-val ((m <Path>))
...
(cl:defmethod fly_now-val ((m <Path>))
...
(cl:defmethod stop_at_waypoints-val ((m <Path>))
...
(cl:defmethod override_constraints-val ((m <Path>))
...
(cl:defmethod override_max_velocity_horizontal-val ((m <Path>))
...
(cl:defmethod override_max_acceleration_horizontal-val ((m <Path>))
...
(cl:ensure-generic-function 'override_max_jerk_horizontal-val :lambda-list '(m))
(cl:defmethod override_max_jerk_horizontal-val ((m <Path>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:override_max_jerk_horizontal-val is deprecated.  Use mrs_msgs-msg:override_max_jerk_horizontal instead.")
  (override_max_jerk_horizontal m))

(cl:ensure-generic-function 'override_max_velocity_vertical-val :lambda-list '(m))
(cl:defmethod override_max_velocity_vertical-val ((m <Path>))
...
(cl:defmethod override_max_acceleration_vertical-val ((m <Path>))
...
(cl:ensure-generic-function 'override_max_jerk_vertical-val :lambda-list '(m))
(cl:defmethod override_max_jerk_vertical-val ((m <Path>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:override_max_jerk_vertical-val is deprecated.  Use mrs_msgs-msg:override_max_jerk_vertical instead.")
  (override_max_jerk_vertical m))

(cl:ensure-generic-function 'relax_heading-val :lambda-list '(m))
(cl:defmethod relax_heading-val ((m <Path>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Path>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'override_max_acceleration_horizontal))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'override_max_jerk_horizontal))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'override_max_acceleration_vertical))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'override_max_jerk_vertical))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Path>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'override_max_jerk_horizontal) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'override_max_jerk_vertical) (roslisp-utils:decode-double-float-bits bits)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Path>)))
  ...
  "a198d3f4e3c407d1d87c51afdfa45189")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Path)))
  "Returns md5sum for a message object of type 'Path"
  "a198d3f4e3c407d1d87c51afdfa45189")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Path>))
  ...
  (cl:list 'Path
    ...
    (cl:cons ':override_max_jerk_horizontal (override_max_jerk_horizontal msg))
    ...
    (cl:cons ':override_max_jerk_vertical (override_max_jerk_vertical msg))

...
(cl:defmethod cl:initialize-instance :after ((m <EstimatedState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EstimatedState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrs_msgs-msg:<EstimatedState> is deprecated: use mrs_msgs-msg:EstimatedState instead.")))
...
(cl:defmethod state-val ((m <EstimatedState>))
...
(cl:defmethod covariance-val ((m <EstimatedState>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EstimatedState>)))
  ...
  "699a0b2414bebaf5ed2e4d8b73080cac")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EstimatedState)))
  "Returns md5sum for a message object of type 'EstimatedState"
  "699a0b2414bebaf5ed2e4d8b73080cac")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EstimatedState>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%float64[] state~%float64[] covariance~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EstimatedState)))
  "Returns full string definition for message of type 'EstimatedState"
  (cl:format cl:nil "std_msgs/Header header~%float64[] state~%float64[] covariance~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))

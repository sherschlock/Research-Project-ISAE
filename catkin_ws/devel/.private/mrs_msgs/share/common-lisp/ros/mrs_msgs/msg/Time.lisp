...
(cl:defmethod cl:initialize-instance :after ((m <Time>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Time)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrs_msgs-msg:<Time> is deprecated: use mrs_msgs-msg:Time instead.")))
...
(cl:defmethod clock_status-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:clock_status-val is deprecated.  Use mrs_msgs-msg:clock_status instead.")
  (clock_status m))

(cl:ensure-generic-function 'offset-val :lambda-list '(m))
(cl:defmethod offset-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:offset-val is deprecated.  Use mrs_msgs-msg:offset instead.")
  (offset m))

(cl:ensure-generic-function 'offset_std-val :lambda-list '(m))
(cl:defmethod offset_std-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:offset_std-val is deprecated.  Use mrs_msgs-msg:offset_std instead.")
  (offset_std m))

(cl:ensure-generic-function 'utc_offset-val :lambda-list '(m))
(cl:defmethod utc_offset-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:utc_offset-val is deprecated.  Use mrs_msgs-msg:utc_offset instead.")
  (utc_offset m))

(cl:ensure-generic-function 'utc_year-val :lambda-list '(m))
(cl:defmethod utc_year-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:utc_year-val is deprecated.  Use mrs_msgs-msg:utc_year instead.")
  (utc_year m))

(cl:ensure-generic-function 'utc_month-val :lambda-list '(m))
(cl:defmethod utc_month-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:utc_month-val is deprecated.  Use mrs_msgs-msg:utc_month instead.")
  (utc_month m))

(cl:ensure-generic-function 'utc_day-val :lambda-list '(m))
(cl:defmethod utc_day-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:utc_day-val is deprecated.  Use mrs_msgs-msg:utc_day instead.")
  (utc_day m))

(cl:ensure-generic-function 'utc_hour-val :lambda-list '(m))
(cl:defmethod utc_hour-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:utc_hour-val is deprecated.  Use mrs_msgs-msg:utc_hour instead.")
  (utc_hour m))

(cl:ensure-generic-function 'utc_minute-val :lambda-list '(m))
(cl:defmethod utc_minute-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:utc_minute-val is deprecated.  Use mrs_msgs-msg:utc_minute instead.")
  (utc_minute m))

(cl:ensure-generic-function 'utc_millisecond-val :lambda-list '(m))
(cl:defmethod utc_millisecond-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:utc_millisecond-val is deprecated.  Use mrs_msgs-msg:utc_millisecond instead.")
  (utc_millisecond m))

(cl:ensure-generic-function 'utc_status-val :lambda-list '(m))
(cl:defmethod utc_status-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:utc_status-val is deprecated.  Use mrs_msgs-msg:utc_status instead.")
  (utc_status m))

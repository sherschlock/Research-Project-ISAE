...
(cl:defmethod cl:initialize-instance :after ((m <RangeInformation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RangeInformation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrs_msgs-msg:<RangeInformation> is deprecated: use mrs_msgs-msg:RangeInformation instead.")))

(cl:ensure-generic-function 'prn_number-val :lambda-list '(m))
(cl:defmethod prn_number-val ((m <RangeInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:prn_number-val is deprecated.  Use mrs_msgs-msg:prn_number instead.")
  (prn_number m))

(cl:ensure-generic-function 'glofreq-val :lambda-list '(m))
(cl:defmethod glofreq-val ((m <RangeInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:glofreq-val is deprecated.  Use mrs_msgs-msg:glofreq instead.")
  (glofreq m))

(cl:ensure-generic-function 'psr-val :lambda-list '(m))
(cl:defmethod psr-val ((m <RangeInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:psr-val is deprecated.  Use mrs_msgs-msg:psr instead.")
  (psr m))

(cl:ensure-generic-function 'psr_std-val :lambda-list '(m))
(cl:defmethod psr_std-val ((m <RangeInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:psr_std-val is deprecated.  Use mrs_msgs-msg:psr_std instead.")
  (psr_std m))

(cl:ensure-generic-function 'adr-val :lambda-list '(m))
(cl:defmethod adr-val ((m <RangeInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:adr-val is deprecated.  Use mrs_msgs-msg:adr instead.")
  (adr m))

(cl:ensure-generic-function 'adr_std-val :lambda-list '(m))
(cl:defmethod adr_std-val ((m <RangeInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:adr_std-val is deprecated.  Use mrs_msgs-msg:adr_std instead.")
  (adr_std m))

(cl:ensure-generic-function 'dopp-val :lambda-list '(m))
(cl:defmethod dopp-val ((m <RangeInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:dopp-val is deprecated.  Use mrs_msgs-msg:dopp instead.")
  (dopp m))

(cl:ensure-generic-function 'noise_density_ratio-val :lambda-list '(m))
(cl:defmethod noise_density_ratio-val ((m <RangeInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:noise_density_ratio-val is deprecated.  Use mrs_msgs-msg:noise_density_ratio instead.")
  (noise_density_ratio m))

(cl:ensure-generic-function 'locktime-val :lambda-list '(m))
(cl:defmethod locktime-val ((m <RangeInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:locktime-val is deprecated.  Use mrs_msgs-msg:locktime instead.")
  (locktime m))

(cl:ensure-generic-function 'tracking_status-val :lambda-list '(m))
(cl:defmethod tracking_status-val ((m <RangeInformation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:tracking_status-val is deprecated.  Use mrs_msgs-msg:tracking_status instead.")
  (tracking_status m))

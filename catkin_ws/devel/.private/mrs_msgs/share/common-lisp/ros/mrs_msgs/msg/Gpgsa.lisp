...
(cl:defmethod cl:initialize-instance :after ((m <Gpgsa>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gpgsa)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrs_msgs-msg:<Gpgsa> is deprecated: use mrs_msgs-msg:Gpgsa instead.")))
...
(cl:defmethod auto_manual_mode-val ((m <Gpgsa>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:auto_manual_mode-val is deprecated.  Use mrs_msgs-msg:auto_manual_mode instead.")
  (auto_manual_mode m))

(cl:ensure-generic-function 'fix_mode-val :lambda-list '(m))
(cl:defmethod fix_mode-val ((m <Gpgsa>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:fix_mode-val is deprecated.  Use mrs_msgs-msg:fix_mode instead.")
  (fix_mode m))

(cl:ensure-generic-function 'prn-val :lambda-list '(m))
(cl:defmethod prn-val ((m <Gpgsa>))
...
(cl:defmethod pdop-val ((m <Gpgsa>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:pdop-val is deprecated.  Use mrs_msgs-msg:pdop instead.")
  (pdop m))
...
(cl:defmethod vdop-val ((m <Gpgsa>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrs_msgs-msg:vdop-val is deprecated.  Use mrs_msgs-msg:vdop instead.")
  (vdop m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Gpgsa>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'prn))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Gpgsa>) istream)
  ...
  (cl:setf (cl:slot-value msg 'prn) (cl:make-array __ros_arr_len))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Gpgsa>)))
  ...
  "77674f482c414fa310e65792b69a0af3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Gpgsa)))
  "Returns md5sum for a message object of type 'Gpgsa"
  "77674f482c414fa310e65792b69a0af3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Gpgsa>)))
  ...
  (cl:format cl:nil "# Message from GPGSA NMEA String~%Header header~%~%string message_id~%~%string auto_manual_mode~%uint8 fix_mode~%~%uint8[] prn~%~%float32 pdop~%float32 hdop~%float32 vdop~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Gpgsa)))
  "Returns full string definition for message of type 'Gpgsa"
  (cl:format cl:nil "# Message from GPGSA NMEA String~%Header header~%~%string message_id~%~%string auto_manual_mode~%uint8 fix_mode~%~%uint8[] prn~%~%float32 pdop~%float32 hdop~%float32 vdop~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Gpgsa>))
  (cl:+ 0
     ...
     1
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'prn) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 1)))
     4
     4
     4
))

...
if(mrs_subt_planning_lib_CONFIG_INCLUDED)
  return()
endif()
set(mrs_subt_planning_lib_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(mrs_subt_planning_lib_SOURCE_PREFIX /home/akash/catkin_ws/src/subt_planning_lib)
  set(mrs_subt_planning_lib_DEVEL_PREFIX /home/akash/catkin_ws/devel/.private/mrs_subt_planning_lib)
  set(mrs_subt_planning_lib_INSTALL_PREFIX "")
  set(mrs_subt_planning_lib_PREFIX ${mrs_subt_planning_lib_DEVEL_PREFIX})
else()
  set(mrs_subt_planning_lib_SOURCE_PREFIX "")
  set(mrs_subt_planning_lib_DEVEL_PREFIX "")
  set(mrs_subt_planning_lib_INSTALL_PREFIX /home/akash/catkin_ws/install)
  set(mrs_subt_planning_lib_PREFIX ${mrs_subt_planning_lib_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'mrs_subt_planning_lib' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND mrs_subt_planning_lib_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/akash/catkin_ws/devel/.private/mrs_subt_planning_lib/lib;/home/akash/catkin_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(mrs_subt_planning_lib_LIBRARY_DIRS ${lib_path})
      list(APPEND mrs_subt_planning_lib_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'mrs_subt_planning_lib'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND mrs_subt_planning_lib_LIBRARIES ${lib})
    endif()
  endif()
...
set(mrs_subt_planning_lib_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${mrs_subt_planning_lib_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 mrs_subt_planning_lib_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${mrs_subt_planning_lib_dep}_FOUND)
      find_package(${mrs_subt_planning_lib_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mrs_subt_planning_lib_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(mrs_subt_planning_lib_INCLUDE_DIRS ${${mrs_subt_planning_lib_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(mrs_subt_planning_lib_LIBRARIES ${mrs_subt_planning_lib_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${mrs_subt_planning_lib_dep}_LIBRARIES})
  _list_append_deduplicate(mrs_subt_planning_lib_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(mrs_subt_planning_lib_LIBRARIES ${mrs_subt_planning_lib_LIBRARIES})

  _list_append_unique(mrs_subt_planning_lib_LIBRARY_DIRS ${${mrs_subt_planning_lib_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(mrs_subt_planning_lib_EXPORTED_TARGETS ${${mrs_subt_planning_lib_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${mrs_subt_planning_lib_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
